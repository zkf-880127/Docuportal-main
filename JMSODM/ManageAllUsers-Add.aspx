...
<script language="VB" runat="server">
    ...
    Sub RefreshUserRolesList()
        Dim strUsrname = tbNewUsername.Text.Trim()
        ...
        LoadDropDownValues(strSQL, "Role_ID", "Role_ID", Me.lbxAssignedToValues, strUsrname)
        ...
        LoadDropDownValues(strSQL, "Role_ID", "Role_ID", Me.lbxToValues, strUsrname)
                ...
                Try
                    For i As Integer = 0 To lbxToValues.Items.Count - 1
                        ...
                        If lbxToValues.Items(i).Selected = True Then
                            ...
                            AddRoleToUser(tbNewUsername.Text, lbxToValues.Items(i).Text)
                        End If
                    Next i
    ...
    Sub UserDropDownLists()
        Dim strSQL As String = "SELECT distinct [UserID] FROM [dbo].[tbl_usr_Logins] WHERE (([disabled] IS NULL) OR ([disabled]<>1)) ORDER BY [UserID]"
