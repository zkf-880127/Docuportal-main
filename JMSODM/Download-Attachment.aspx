...
<script language="VB" runat="server">
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Catch ex As Exception
            ...
            Exit Sub
        End Try
        Dim anID As String = Request.QueryString.Get("id")
        Dim StrIArchived As Int16 = StrHelp.GetInt(Request.QueryString.Get("IArchived")) 'ImageArchived  zkf 2012107-9 update archive database

        If CustomRoles.RolesForPageLoad() Then
            If CommonUtilsv2.Validate(anID, CommonUtilsv2.DataTypes.Int, True, True, True) Then
                DownloadAttachment(anID, StrIArchived)
            Else
    ...
    Protected Sub DownloadAttachment(ByVal strAttachmentID As String, ByVal StrIArchived As String)
        ...
        sqlCmd.Parameters.Add(New SqlClient.SqlParameter("@ID", strAttachmentID))
        ...
        Try
            ...
            While sqldr.Read
                If sqldr.Item(1) Is System.DBNull.Value Then
                    errString = "Cannot find or display Public document " & strAttachmentID
                    errLocation = "DownloadAttachment()"
        ...
        Catch ex As Exception
            ...
            errLocation = "DownloadAttachment"
            'LogError(errString, errLocation)  'Note:  This is commented out as you ALWAYS get a Thread Aborted on the downloads (JWN)
        Finally
            sqlCnn.Dispose()
            sqlCmd.Dispose()
            sqlCnn = Nothing
        ...
        <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="wrapper">
		    <tr>
	            <td class="body" colspan="2">
                    <table width="100%">
		                <tr class="body_title">
		                    <td colspan="7" align="left" class="body_title">Attachment Download</td>
		                </tr>
		                <tr class="body_plain" colspan="2">
                            <td align="left"><br />
                                We're sorry . . . that attachment is not available right now.&nbsp;&nbsp;<b>Please try back later.</b> 
                                <br />
                                <br />
